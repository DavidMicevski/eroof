...
<div class="row">
    <div class="panel panel-default" style="border-top: none; background-color: #f8f8f8; ">
        <div id="layer-tool" class="col-md-1">
            <div class="row">
                <div class="col-md-8">
                    <button id="all" class="btn layer_btn base" style="width: 100%" onclick="allLayerClick();">All Layers</button>
                    <button id="plus" class="btn layer_btn" style="width: 100%">+</button>
                    <button id="layer1" class="btn layer_btn" style="width: 100%" onclick="layer1_click();">1</button>
                    <button id="up" class="btn layer_btn" style="width: 100%">Move Up</button>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-7" style="bottom: 20px; position: absolute; z-index: 3000">
            <div class="col-md-5" style="border: 1px solid #9c9c9d; border-radius: 3px; padding-left: 0px; padding-right: 0px; background-color: #fff">
                <a class="btn cancel" style="border: none; width: 11%; color: #9c9c9d" onclick="rotateleft(-1)" title="Rotate Left (1 degree)"><i class="fa fa-undo"></i></a>
                <a class="btn cancel" style="border: none; width: 11%; color: #9c9c9d" onclick="rotateleft(-10)" title="Rotate Left (10 degrees)"><i class="fa fa-mail-reply"></i></a>
                <a class="btn cancel" style="border: none; width: 11%; color: #9c9c9d" onclick="rotateright(10)" title="Rotate Right (10 degrees)"><i class="fa fa-mail-forward"></i></a>
                <a class="btn cancel" style="border: none; width: 10%; color: #9c9c9d" onclick="rotateright(1)" title="Rotate Right (1 degree)"><i class="fa fa-rotate-right"></i></a>
                <a class="btn cancel" style="border: none; width: 10%; color: #9c9c9d" title="Toggle Snapping"><i class="fa fa-scissors"></i></a>
                <a class="btn cancel" style="border: none; width: 10%; color: #9c9c9d" onclick="showgrid()" title="Show Grid"><i class="fa fa-table"></i></a>
                <a class="btn cancel" style="border: none; width: 10%; color: #9c9c9d" onclick="crosshair()" title="Cross Hair"><i class="fa fa-plus"></i></a>
                <a class="btn cancel" style="border: none; width: 10%; color: #9c9c9d" onclick="zoomin()" title="Zoom In"><i class="fa fa-search-plus"></i></a>
                <a class="btn cancel" style="border: none; width: 10%; color: #9c9c9d" onclick="zoomout()" title="Zoom Out"><i class="fa fa-search-minus"></i></a>
            </div>                
            <div class="col-md-2" style="border: 1px solid #9c9c9d; border-radius: 3px; padding-left: 0px; padding-right: 0px; background-color: #fff">
                <a class="btn cancel" style="border: none; color: #9c9c9d" href="https://www.google.com/maps/@31.7618778,-106.4850217,120m/data=!3m1!1e3" target="_blank"><i class="fa fa-external-link"></i><span style="padding-left: 10px;">View Google Maps</span></a>
            </div>             
            <div class="col-md-2" style="border: 1px solid #9c9c9d; border-radius: 3px; background-color: #fff">
                <a class="btn cancel" style="border: none; color: #9c9c9d" href="https://pitch.roofr.com/?lat=31.7618778&lng=-106.4850217" target="_blank"><i class="fa fa-external-link"></i><span style="padding-left: 10px;">View Pitch</span></a>
            </div>             
        </div>
        <div id="grid" class="col-md-12" style="pointer-events: none;"></div>
        <div id="vertical"></div>
        <div id="horizontal"></div>
        <div id="map" class="col-md-12" style="height: 860px; background: #f8f8f8;">
...
<script type="text/javascript">
    ...
    var polylines = [], deleteEdgeStatus = false, lineColor = null, changeLineStatus = false, lineLengthChangeable = false;
    ...
    $(document).ready(function(){
        ...
        map.on('draw:drawvertex', function (e) {
            ...
            if (resetClicked && vertextCnt == 1) {
                setInchModal.style.display = "block";
                resetClicked = false;
            }
            if (!inchSetted && vertextCnt == 1) {
                setInchModal.style.display = "block";
            }
            ...
            if (la1_isClick) {
                ...
                for (var j = 0; j < layer1[count].length - 1; j ++) {
                    ...
                    polyline.on('click', function(e) {
                        var target_polylines = [];
                        for (var i = 0; i < layer1_lines.length; i ++) {
                            if (layer1_lines[i].pgindex == e.target.pgindex)
                                target_polylines.push(e.target);
                        }
                        ...
                        if (changeLineStatus) {
                            ...
                            if (polygon_pitch == 0) {
                                ...
                                // if (e.target.index == 0) {
                                //     if (target_polylines[e.target.index + 1].pitchsetted == true || target_polylines[target_polylines.length - 1].pitchsetted == true) {
                                //         lineLengthChangeable = true;
                                //     } else {
                                //         lineLengthChangeable = false;
                                //     }
                                // } else {
                                //     if (target_polylines[e.target.index + 1].pitchsetted == true || target_polylines[e.target.index - 1].pitchsetted == true) {
                                //         lineLengthChangeable = true;
                                //     } else {
                                //         lineLengthChangeable = false;
                                //     }
                    ...
                    if (j == layer1[count].length - 2) {
                        ...
                        polyline.on('click', function(e) {
                            ...
                            if (changeLineStatus) {
                                // if (target_polylines[0].pitchSetted == '#3388ff' || target_polylines[e.target.index].pitchSetted == '#3388ff') {
                                //     lineLengthChangeable = true;
                                // } else {
                                //     lineLengthChangeable = false;
                                // }
    ...
    function rotateright(value) {
        var x = ($('.content-wrapper').width() - $('img').width()) / 2;
        var y = ($('.content-wrapper').height() - $('img').height()) / 2;
        degree += value;
        ...
        if (la1_isClick) {
            for (var i = 0; i < layer1_lines.length; i ++) {
                if (layer1_lines[i].status == 1) {
                    layer1_lines[i].setStyle({color: '#3388ff'});
            ...
            for (var i = 0; i < layer2_lines.length; i ++) {
                if (layer2_lines[i].status == 1) {
                    layer2_lines[i].setStyle({color: '#3388ff'});
            ...
            for (var i = 0; i < layer3_lines.length; i ++) {
                if (layer3_lines[i].status == 1) {
                    layer3_lines[i].setStyle({color: '#3388ff'});
            ...
            for (var i = 0; i < layer4_lines.length; i ++) {
                if (layer4_lines[i].status == 1) {
                    layer4_lines[i].setStyle({color: '#3388ff'});
            ...
            for (var i = 0; i < layer5_lines.length; i ++) {
                if (layer5_lines[i].status == 1) {
                    layer5_lines[i].setStyle({color: '#3388ff'});
    ...
    function resetData() {
        ...
        layer1_polygon = [], layer2_polygon = [], layer3_polygon = [], layer4_polygon = [], layer5_polygon = [];
    }
    ...
    function layer2_click() {
        ...
        $('#layer2').removeClass('layer_btn');
        $('#layer2').addClass('btn-primary');
    ...
    function layer3_click() {
        ...
        $('#layer3').removeClass('layer_btn');
        $('#layer3').addClass('btn-primary');
    ...
    function layer4_click() {
        ...
        $('#layer4').removeClass('layer_btn');
        $('#layer4').addClass('btn-primary');
    ...
    function layer5_click() {
        ...
        $('#layer5').removeClass('layer_btn');
        $('#layer5').addClass('btn-primary');
