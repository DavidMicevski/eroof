...
!function(t, e) {
    ...
    function N(t, e, o) {
        t.stopPropagation(),
        t.preventDefault(),
        u.isFunction(o) && !1 === o.call(e, t) || e.modal('hide')
    }
    function y(t) {
    ...
    d.dialog = function(t) {
        ...
        0 < C(t.buttons) && (w(l, function(t, e) {
            var o = u(f.button);
        ...
        t.onHidden) {
            if (!u.isFunction(t.onHidden))
                throw new Error('Argument supplied to "onHidden" must be a function');
            o.on('hidden.bs.modal', t.onHidden)
        }
        if (t.onShow) {
            if (!u.isFunction(t.onShow))
    ...
    d.alert = function() {
        var t;
        if ((t = h('alert', ['ok'], ['message', 'callback'], arguments)).callback && !u.isFunction(t.callback))
    ...
    d.prompt = function() {
        ...
        if (!u.isFunction(r.callback))
            throw new Error('prompt requires a callback');
        if (!f.inputs[r.inputType])
            throw new Error('Invalid prompt type');
        switch (n = u(f.inputs[r.inputType]),
        r.inputType) {
        case 'text':
        case 'textarea':
        case 'email':
        ...
        case 'range':
            ...
            !function(t, e, o) {
                var a = !1
                  ...
                  , n = !0;
                if ('date' === t)
                    e === p || (r = x(e)) ? o === p || (n = x(o)) || console.warn('Browsers which natively support the "date" input type expect date values to be of the form "YYYY-MM-DD" (see ISO-8601 https://www.iso.org/iso-8601-date-and-time-format.html). Bootbox does not enforce this rule, but your max value may not be enforced by this browser.') : console.warn('Browsers which natively support the "date" input type expect date values to be of the form "YYYY-MM-DD" (see ISO-8601 https://www.iso.org/iso-8601-date-and-time-format.html). Bootbox does not enforce this rule, but your min value may not be enforced by this browser.');
                else if ('time' === t) {
                    if (e !== p && !(r = y(e)))
                ...
                return a
            }(r.inputType, r.min, r.max) || (r.min !== p && n.attr('min', r.min),
            r.max !== p && n.attr('max', r.max));
            break;
        case 'select':
            var i = {};
            if (a = r.inputOptions || [],
            ...
            w(a, function(t, e) {
                ...
                e.group && (i[e.group] || (i[e.group] = u('<optgroup />').attr('label', e.group)),
                o = i[e.group]);
                var a = u(f.option);
        ...
        case 'checkbox':
            ...
            n = u('<div class="bootbox-checkbox-list"></div>'),
            w(a, function(t, o) {
            ...
            break;
        case 'radio':
            if (r.value !== p && u.isArray(r.value))
            ...
            w(a, function(t, e) {
                ...
                o.find('label').append('\n' + e.text),
                r.value !== p && e.value === r.value && (o.find('input').prop('checked', !0),
                s = !1),
                n.append(o)
            }),
        ...
        '' !== u.trim(r.message)) {
            ...
            r.message = t;
        return (e = d.dialog(r)).off('shown.bs.modal', O),
